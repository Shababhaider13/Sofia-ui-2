    ...
    <div id="footer1">
        ...
        <div class="iconfooter"><a href="message.php" class="changes1"><i class="fa-solid fa-comments "><span class="noti-alert"></span></i></a></div>
        <div class="iconfooter"><a href="productupload.php" class="changes1"><i class="fa-solid fa-circle-plus "></i></a></div>
        <div class="iconfooter"><a href="notification.php" class="changes1"><i class="fa-solid fa-bell "><span class="noti-alert"></span></i></a></div>
