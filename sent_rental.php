...
<body>
    ...
    <input class="form-control" type="text" value="House no#310 Islamabad" aria-label="address input example" readonly>
    <a href="#" data-toggle="modal" data-target="#exampleModalCenter" style="text-decoration: none; font-size: 16px; color: #888;">ship somewhere else? 
    <i class="fa fa-address-card" style="color: #0d6efd;"></i>
    </a>
