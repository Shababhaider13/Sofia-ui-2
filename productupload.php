                    ...
                    <div class="row">
                        <div class="col-md-12 mx-0">
                            <form id="msform">
                                <!-- progressbar -->
                                <ul id="progressbar">
                                    <li class="active" id="account"> <span class="prog-span">01</span> <strong>Upload Pictures</strong> </li>
                                    <li id="personal"> <span class="prog-span">02</span> <strong>Add Details</strong></li>
                                    <li id="payment"> <span class="prog-span">03</span> <strong>Add Info about Condition</strong></li>
                                    <li id="confirm"> <span class="prog-span">04</span> <strong>Proof the Authenticity</strong></li>
                                </ul>
                                <!-- fieldsets -->
                                <fieldset>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                      ...
                      <option>Acceptable condition</option>
                                ...
                                <h2 style="font-size: 15px; margin-bottom:10px;">Tags Input</h2><input type="text" id="tag-input1">
                                    </div>
                                ...
                                <fieldset>
                                    <div class="form-card" style="box-shadow: none;">
                                        ...
                                        <textarea class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10 " placeholder="Please describe any damages of the product like: missing pieces"  id="review" name="review" style="border: 1px solid #ccc;"></textarea>
